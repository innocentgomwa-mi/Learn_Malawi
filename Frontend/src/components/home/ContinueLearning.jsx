  ...
  return (
    <section className="rounded-[28px] border border-blue-800/50 bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 shadow-sm p-6">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-xl font-heading font-bold text-white">Continue Learning</h2>
          <p className="text-sm text-blue-100/80">Pick up where you left off</p>
        </div>
        <button
          type="button"
      ...
      {isLoading ? (
        ...
        <div className="rounded-3xl border border-border bg-card p-6 text-center text-sm text-muted-foreground">
          ...
          <button
            ...
            className="rounded-full border border-yellow-300 bg-yellow-400 px-4 py-2 text-sm font-semibold text-blue-950 transition hover:bg-yellow-300"
          >
            Explore study notes
          </button>
        </div>
