      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {filtered.map((item) => (
          <button
            ...
            className="text-left bg-card rounded-xl border overflow-hidden cursor-pointer hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group"
          >
            <div className="relative h-40 overflow-hidden">
              ...
              />
              <span className={`absolute top-3 left-3 text-xs font-semibold px-2 py-0.5 rounded-full backdrop-blur-sm ${item.tagColor}`}>
                {item.tag}
              </span>
              <span className="absolute top-3 right-3 text-[10px] font-medium px-2 py-0.5 rounded-full bg-black/40 text-white backdrop-blur-sm">
                {item.category}
              </span>
            </div>
            <div className="p-4">
