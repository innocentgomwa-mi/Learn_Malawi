...
export default function CourseCard({ course, index }) {
  return (
    <motion.div
      ...
      className="group bg-card border border-border/60 rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-foreground/5 hover:border-primary/20 transition-all duration-300 cursor-pointer"
    >
