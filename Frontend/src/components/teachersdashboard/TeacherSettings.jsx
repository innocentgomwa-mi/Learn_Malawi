...
import { Loader2, Volume2, Eye, BookOpen, FileText, HelpCircle, Bell, ImagePlus } from 'lucide-react';
...
export default function TeacherSettings() {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      const hasImage = Boolean(profileImageFile);
        ...
        {activeSection === 'profile' && (
          <SectionCard title="Profile" icon={BookOpen}>
            <div className="flex items-center gap-4 pb-4 border-b border-border">
              <div className="relative w-16 h-16 rounded-full overflow-hidden border-2 border-yellow-300 bg-blue-100 flex items-center justify-center text-blue-700 text-2xl font-bold">
                {profileImagePreview ? (
                ...
                <label
                  className="absolute -bottom-1 -right-1 rounded-full border border-yellow-300 bg-yellow-400 p-2 text-blue-950 cursor-pointer hover:bg-yellow-300"
