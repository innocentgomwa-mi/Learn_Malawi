            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <label className="block text-sm font-medium text-white">
                ...
                <select
                  ...
                  required
                  className="mt-3 w-full rounded-full border border-white/25 bg-white/10 px-5 py-3.5 text-sm text-black outline-none transition focus:border-cyan-300 focus:ring-2 focus:ring-cyan-300/20"
              ...
              <div className="rounded-3xl border border-white/15 bg-white/10 p-4">
                <label className="flex items-start gap-3 text-sm text-white/80">
                  <input
                    ...
                    className="mt-1 h-4 w-4 rounded border-white/30 bg-slate-950/20 text-cyan-400 focus:ring-cyan-300"
                  />
                  <span className="leading-5">
                    I agree to the <Link to="/terms-and-conditions" className="font-semibold text-black hover:text-slate-700 hover:underline">Terms & Conditions</Link> and understand that this account is for personal educational use only.
                  </span>
                </label>
              </div>
