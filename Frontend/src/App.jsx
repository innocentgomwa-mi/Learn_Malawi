...
const AuthenticatedApp = () => {
  const { isLoadingAuth, isLoadingPublicSettings, error, navigateToLogin, isAuthenticated, appPublicSettings, user } = useAuth();
  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/notifications" element={<ProtectedRoute requiredRoles={[]}><Notifications /></ProtectedRoute>} />
