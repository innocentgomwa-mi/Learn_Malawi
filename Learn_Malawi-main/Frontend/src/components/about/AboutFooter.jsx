    ...
    <section className="bg-slate-950 text-white py-20 px-6 md:px-16 lg:px-24">
      <div className="max-w-7xl mx-auto grid gap-10 lg:grid-cols-3">
        <motion.div
          ...
          className="space-y-4"
        >
          <p className="text-sm uppercase tracking-[0.35em] text-primary">About Learn Malawi</p>
          ...
          {[
            ...
            return (
              <div key={item.label} className="flex items-start gap-3">
                <div className="bg-primary text-slate-950 p-3 rounded-xl">
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <p className="text-sm uppercase tracking-[0.35em] text-primary">Stay connected</p>
