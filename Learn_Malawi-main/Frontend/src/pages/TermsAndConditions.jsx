  ...
  return (
    <div className="min-h-screen bg-background p-6 lg:p-10">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        {/* Hero */}
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary/80 to-violet-700 p-8 lg:p-12 text-white">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {HIGHLIGHTS.map(({ icon: Icon, label, desc }) => (
            <div key={label} className="rounded-2xl border border-border bg-card p-5 flex flex-col gap-3">
        ...
        <div className="space-y-4">
          {SECTIONS.map((section) => (
            <div key={section.number} className="group rounded-2xl border border-border bg-card p-6 lg:p-7 transition-all hover:border-primary/30 hover:shadow-md hover:shadow-primary/5">
              <div className="flex items-start gap-5">
                <span className="flex-shrink-0 text-3xl font-bold text-primary/20 group-hover:text-primary/40 transition-colors leading-none mt-0.5 select-none">
                  {section.number}
                </span>
        ...
        {/* Contact footer */}
        <div className="rounded-3xl border border-primary/20 bg-gradient-to-r from-primary/5 to-violet-500/5 p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
          ...
          <a
            ...
            className="inline-flex items-center gap-2.5 rounded-xl bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground hover:bg-primary/90 transition-colors flex-shrink-0"
          >
